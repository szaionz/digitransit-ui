...
//    },
  ...
  defaultEndpoint: {
    address: 'Western Wall, Jerusalem',
    lat: 31.7767226,
    lon: 35.2343777
  },
  ...
  map: {
    ...
    // HSL region + Lahti
    areaBounds: {
          corner1: [34.4, 37.2],  // north-east (extra north & east)
  corner2: [29.1, 33.0], 
    },
  },
  ...
  searchSources: ['osm', 'oa', 'gn', 'wof', 'openstreetmap', 'openaddresses', 'geonames', 'whosonfirst'],
  searchParams: {
    layers: ['address', 'street', 'venue', 'stop'],
  },
